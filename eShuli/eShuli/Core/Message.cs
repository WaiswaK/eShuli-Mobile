namespace eShuli.Core
{
    class Message
    {
        ...
        public static string No_Subject = "Looks like you have not added any units/subjects to your account. Login via the eShuli website and add them first before using the app. Thanks";
        public static string No_Subject_Header = "Missing Course Units / Subjects";
        public static string Offline_File_Unavailable = "This file is only available online, you need an internet Connection to download it";
