    ...
    class DBRetrievalTask
    {
        ...
        private static List<TopicModel> GetTopics(int subId)
        {
            ...
            using (var db = DependencyService.Get<Interfaces.IDatabase>().GetConnection())
            {
                ...
                { 
                    topic = new TopicModel(_topic.TopicID, _topic.Notes, _topic.Overview, _topic.TopicTitle, _topic.teacher_full_names, _topic.Updated_at, _topic.Folder_Id, _topic.Folder_Name);                  
                    topics.Add(topic);
                }
            }
            return topics;
        ...
        public static List<AttachmentModel> OldGetFiles(int assignmentID)
        {
            List<AttachmentModel> attachments = new List<AttachmentModel>();
            AttachmentModel attachment = null;
